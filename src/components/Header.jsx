    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex relative items-center justify-center" onClick={showCart}>
            ...
            />
            {
              menu && (
                <motion.div initial={{ opacity: 0, scale: 0.6 }}
                  ...
                  {
                    user && user.email === "alexgoyal989@gmail.com" && (
                      <NavLink to={"createItem"}>
                        <p className="px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base" onClick={() => setMenu(false)}>
                          New Item <MdAdd />
                        </p>
                      </NavLink>
                    )
